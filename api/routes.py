...
class DataAPI:
    ...
    def __init__(self, data_file_path: str = "data/processed_data.json"):
    ...
    def _register_routes(self):
        ...
        def get_latest_field_data():
            ...
            data = storage.load()
            return data  # load and return the JSON content
        ...
        def get_field_data(field_id: str):
            storage = JSONStorage(self.DATA_FILE_PATH)
            data = storage.load()
            # Return the latest record for the field
        ...
        def health_check():
            return {"status": "ok", "service": "data_ingestion_api"}